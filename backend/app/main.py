...
from app.routers import auth, lab, membership, intake, user, testdictionary, adminui
...
app.include_router(intake.router, prefix=f"{settings.API_V1_STR}",  tags=["Intakes & Orders"])
